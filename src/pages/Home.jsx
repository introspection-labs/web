...
function Home() {
  useEffect(() => {
    // Ensure overflow is hidden for homepage
      ...
      <div style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        <div className="dawn-text-overlay" style={{
          ...
          <p style={{ 
            ...
            <span style={{ fontSize: '20px' }}>Your thoughts shouldn't cost you. {'\n\n'} Dawn is the best STT for macOS, powered by AI, free forever</span>
          </p>
          <button className="download-button" style={{
            ...
            Download for{' '}
            <img src="/apple.png" alt="Apple" style={{ height: '18px', display: 'inline-block', verticalAlign: 'middle' }} />
          </button>
        </div>
